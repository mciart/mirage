...
use super::types::{
    ...
    InstanceMsg, Message, MirageConfig, SystemMsg,
};
use crate::validation;

/// Main GUI application state for the Mirage VPN client.
///
...
impl MirageGui {
    /// Creates a new MirageGui application instance.
    ///
