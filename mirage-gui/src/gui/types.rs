...
pub enum ConfigState {
    ...
    Connecting {
        ...
        instance: Option<MirageInstance>,
    },
...
impl ConfigState {
    ...
    pub fn instance(&self) -> Option<&MirageInstance> {
        match self {
    ...
    pub fn instance_mut(&mut self) -> Option<&mut MirageInstance> {
        match self {
            Self::Connected { instance, .. } => Some(instance),
            _ => None,
        }
...
/// Represents a running Mirage VPN client instance.
///
...
impl fmt::Debug for MirageInstance {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("MirageInstance")
...
/// Configuration file information for a Mirage VPN client.
#[derive(Clone)]
...
pub enum InstanceMsg {
    ...
    ConnectedInstance(MirageInstance, Option<ConnectionMetrics>),
