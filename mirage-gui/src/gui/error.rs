//! Error types for the Mirage GUI.
//!
...
/// Conversion from mirage::MirageError to GuiError.
///
/// Maps MirageError variants to appropriate GuiError variants where possible,
/// preserving the original error message without adding redundant prefixes.
impl From<mirage::MirageError> for GuiError {
    fn from(err: mirage::MirageError) -> Self {
        // Use the error's display message directly without wrapping
        // MirageError already has well-formatted user-facing messages
