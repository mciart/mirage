...
impl MirageError {
    ...
    ///
    /// ### Returns
    /// A new `MirageError::System` variant containing the provided message.
    ...
    ///
    /// ### Returns
    /// A new `MirageError::Auth` variant with `AuthError::InvalidCredentials`.
    ...
    ///
    /// ### Returns
    /// A new `MirageError::Network` variant with `NetworkError::ConnectionFailed`.
    ...
    ///
    /// ### Returns
    /// A new `MirageError::Config` variant with `ConfigError::FileNotFound`.
...
///
/// This type alias provides a convenient shorthand for Results that use MirageError
