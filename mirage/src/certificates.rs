...
mod tests {
    ...
    const VALID_CERT_PEM: &str = include_str!("../../mirage-tests/tests/static/server_cert.pem");
    const VALID_KEY_PEM: &str = include_str!("../../mirage-tests/tests/static/server_key.pem");
